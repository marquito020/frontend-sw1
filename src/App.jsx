...
import { AuthenticateTrue, AuthenticateFalse } from "./guards/Authenticate";
import UsersIndex from "./pages/users";
import CreateEventos from "./pages/eventos/create";
import InfoEvento from "./pages/eventos/info";
import RolesIndex from "./pages/roles";
import CreateFormulario from "./pages/formularios/create";
import FormulariosIndex from "./pages/formulario-admin";
import ContratarFotografo from "./pages/organizador";
import CrearContratarFotografo from "./pages/organizador/create";
import FotografoEventos from "./pages/fotografo/eventos";
import FotografoEventosInfo from "./pages/fotografo/info";
import ShopEventos from "./pages/eventos/shop";
import { ShoppingCartProvider } from "./contexts/ShoppingCartContext";
import PayFotos from "./shop/pay";
import ComprasFotos from "./shop/compras";
function App() {
  return (
    <main className="App  relative">
      <ShoppingCartProvider>
        ...
        /> */}
          <Route element={<AuthenticateFalse />}>
          ...
          <Route element={<AuthenticateTrue />}>
            <Route path="/*" element={<Layout />}>
              <Route path="" element={<Dashboard />} />
              {/* Usuarios */}
              <Route path="usuarios" element={<UsersIndex />} />
              {/* Formularios Admin */}
              <Route path="formularios" element={<FormulariosIndex />} />
              {/* Roles */}
              <Route path="roles" element={<RolesIndex />} />
              {/* Formularios */}
              <Route path="formulario" element={<CreateFormulario />} />
              {/* Eventos */}
              <Route path="eventos" element={<Eventos />} />
              {/* Shop */}
              <Route path="eventos-shop" element={<ShopEventos />} />
              {/* Pay Shop */}
              <Route path="eventos-shop/pay" element={<PayFotos />} />
              {/* Compras Fotos */}
              <Route path="eventos-shop/compras" element={<ComprasFotos />} />
              <Route path="crear-evento" element={<CreateEventos />} />
              <Route path="eventos/:id" element={<InfoEvento />} />
              {/* Contratar Fotografo */}
              <Route path="contratar-fotografo" element={<ContratarFotografo />} />
              {/* Crear Contratar Fotografo */}
              <Route path="contratar-fotografo/:id" element={<CrearContratarFotografo />} />

              {/* Fotografo */}
              <Route path="fotografo-eventos" element={<FotografoEventos />} />
              <Route path="fotografo-eventos/:id" element={<FotografoEventosInfo />} />
