...
import { facturaPost } from "../models/factura.model";
...
let personalSchema = yup.object().shape({
    ...
    titular: yup.string().required("Titular is required"),
});
...
const PayFotos = () => {
    ...
    const onSubmit = (data) => {
        ...
        if (isLastStep) {
            if (checked) {
                console.log(data);
                const listaFotos = cartItems.map((item) => {
                    return item._id;
                });
                ...
                const dataSend = {
                    ...
                    mesVencimientoTarjeta: data.expireMonth,
                    anioVencimientoTarjeta: data.expireYear,
                    codigoSeguridadTarjeta: data.cvv,
                    titularTarjeta: data.titular,
                };
                console.log(dataSend);
                const response = facturaPost(dataSend);
                console.log(response);
                if (response) {
                    alert("Compra realizada con exito");
                    setCartItems([]);
                    window.location.href = "/eventos-shop";
                } else {
                                    ...
                                    <div className="mt-10">
                                        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                                            <div className="flex items-center justify-between">
                                                <Icon icon="bx:bx-cart" className="w-6 h-6" />
                                        ...
                                        <div className="mt-5">
                                            ...
                                            <div className="flex items-center justify-between">
                                                ...
                                                <span className="text-base text-slate-800 dark:text-slate-300 my-6">
                                                    Total: Bs. {total}
                                                </span>
                                            </div>
                                        </div>
                            ...
                            {stepNumber === 1 && (
                                <div>
                                    <div className="grid md:grid-cols-2 grid-cols-1 gap-5">
                                        <div className="md:col-span-2 col-span-1 mt-14">
                                            ...
                                            <div className="lg:col-span-2 md:col-span-2 col-span-1">
                                                ...
                                                <div className="mt-5 flex rounded-md shadow-sm">
                                                    <select
                                                        id="expireMonth"
                                                        name="expireMonth"
                                                        className="focus:ring-slate-500 focus:border-slate-500 flex-1 block w-full rounded-md sm:text-sm border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-300"
                                                        defaultValue="01"
                            ...
                            {stepNumber === 2 && (
                                <div>
                                    <div className="grid grid-cols-1 gap-5">
                                        <div className="">
                                            <h4 className="text-base text-slate-800 dark:text-slate-300 mb-6 mt-14">
